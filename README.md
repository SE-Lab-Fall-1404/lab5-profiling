...
_نکته: تصاویر مربوط به Thread Activity و سایر بخش‌های Profiling می‌بایست با استفاده از YourKit تهیه و در این گزارش قرار گیرند._
...
_تصاویر مربوط به Hot Spots شناسایی شده توسط YourKit در این بخش قرار می‌گیرد. این تصاویر باید شامل:_
- _نقاط بحرانی مصرف CPU_
- _توابع با بیشترین زمان اجرا_
- _مقایسه قبل و بعد از بهینه‌سازی_

#### 6.2 Object Allocation Tracking

_تصاویر مربوط به ردیابی تخصیص اشیاء (Object Allocation) باید شامل:_
- _نمودار تخصیص حافظه در طول زمان_
- _مقایسه تعداد اشیاء ایجاد شده قبل و بعد از بهینه‌سازی_
- _تجزیه و تحلیل انواع اشیاء ایجاد شده_

#### 6.3 GC Activity Comparison

_تصاویر مربوط به فعالیت Garbage Collector باید شامل:_
- _نمودار فعالیت GC در طول زمان_
- _زمان توقف (pause time) GC_
- _مقایسه فرکانس و مدت زمان GC قبل و بعد از بهینه‌سازی_
